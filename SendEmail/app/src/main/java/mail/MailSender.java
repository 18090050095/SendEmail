...
//		});
	 ...
	 * @return
     */
	public boolean sendFileMail(MailInfo info, ArrayList<File> fileArrayList){
		Message attachmentMail = createAttachmentMail(info,fileArrayList);
		try {
	 ...
	 * @return
	 */
	private Message createAttachmentMail(final MailInfo info, ArrayList<File> fileArrayList) {
		//创建邮件
